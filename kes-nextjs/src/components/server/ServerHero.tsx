// components/server/ServerHero.tsx
import Image from 'next/image'
import ClientHeroAnimations from '../client/ClientHeroAnimations'
...
export default function ServerHero({ heroTitle, heroSubtitle }: ServerHeroProps) {
  ...
  return (
    <div id="home" className="bg-gradient-to-b from-sky-100 via-sky-50 to-white lg:bg-white min-h-screen lg:h-auto lg:min-h-[100%] relative overflow-hidden">
              ...
              <div className="mx-auto max-w-3xl text-center lg:text-left">
                <h1 className="mx-auto max-w-4xl font-display text-4xl sm:text-5xl md:text-6xl lg:text-8xl font-medium tracking-tight text-slate-900 leading-tight">
                  <span className="relative block mb-2 lg:mb-0">
                    <span className="whitespace-nowrap bg-gradient-to-r from-slate-900 to-slate-700 bg-clip-text text-transparent lg:bg-none lg:text-slate-900">
                      {firstPart}
                    </span>
                  </span> 
                  <span className="relative text-blue-600 block lg:inline">
                    ...
                    <span className="relative bg-gradient-to-r from-blue-600 to-sky-500 bg-clip-text text-transparent lg:bg-none lg:text-blue-600">
                      {highlightedPart}
                    </span>
                  </span>
                </h1>
                
                <p className="mt-8 mb-11 text-lg sm:text-xl lg:text-2xl text-balance leading-8 lg:leading-9 text-gray-600 text-center lg:text-left max-w-2xl mx-auto lg:mx-0 relative">
