    ...
    <div className="relative">
      <div className="mx-auto max-w-7xl">
          ...
          <div className="relative px-6 py-8 sm:py-40 sm:px-40 lg:px-8 lg:py-56">
            <div className="mx-auto max-w-3xl">
              ...
              <p className="mt-6 text-lg leading-8 text-gray-600">
                At KES Global Advisors, we provide strategic financial solutions tailored to your unique needs. Trust our experienced advisors to guide you towards a prosperous future.
              </p>
        ...
        <div className="absolute inset-y-0 right-0 hidden lg:block w-1/2 bg-gray-50">
          <img
            alt=""
            src="https://i.postimg.cc/zvJFh6BV/Exp-Capture-2.jpg"
